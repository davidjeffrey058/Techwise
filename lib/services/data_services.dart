...
class DataServices {
  ...
  Stream<List<ProductProperties>> getCartOrWishlistData(String uid, bool isCart) {
    String collectionPath = isCart ? 'cart' : 'wishlist';
    final userRef = FirebaseFirestore.instance.collection('Users').doc(uid).collection(collectionPath);
